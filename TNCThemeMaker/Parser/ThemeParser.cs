...
namespace TNCThemeMaker.Parser
{
    class ThemeParser
    {
        ...
        public readonly string[] ItemOrder = { "char_select_right", "char_select_left", "char_buttons", "char_select", "left_evidence_icon", "right_evidence_icon", "evidence_present", "evidence_right", "evidence_left", "evidence_description", "evidence_x", "evidence_image_button", "evidence_image_name", "evidence_image", "evidence_update", "evidence_delete", "evidence_edit_name", "evidence_overlay", "evidence_buttons", "evidence_name", "evidence_load", "evidence_save", "evidence_new", "evidence_background", "jury_examination", "judicial_findings", "rebuttal", "not_guilty", "guilty", "cross_examination", "witness_testimony", "prosecution_plus", "prosecution_bar", "defense_minus", "defense_bar", "defense_plus", "prosecution_minus", "takethat", "objection", "holdit", "emote_right", "emote_left", "emotes", "custom2", "custom", "change_character", "config_button", "call_mod", "area_list", "ic_chat_name", "evidence_button", "speakthrough", "hide_scene", "hide_actor", "shake", "realization", "mirrorv", "flip", "pre", "text_color", "pos_dropdown", "emote_dropdown", "ic_chat_message", "ooc_chat_message", "server_chatlog", "ic_chatlog", "music_search", "music_list", "showname", "message", "chatbox", "viewport" , "courtroom" };
